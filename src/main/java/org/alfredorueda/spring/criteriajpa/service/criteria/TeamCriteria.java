...
/**
 * Criteria class for the {@link org.alfredorueda.spring.criteriajpa.domain.Team} entity. This class is used
 * in {@link org.alfredorueda.spring.criteriajpa.web.rest.TeamResource} to receive all the possible filtering options from
...
public class TeamCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, city, playerId, distinct);
    }
